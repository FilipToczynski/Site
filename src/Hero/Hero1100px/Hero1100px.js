...
import styles from './Hero1100px.module.css';
      ...
      {!langctx.language && (
        <div className={styles.hero}>
          <p className={styles.hero__welcome}>
            ...
            Filip, I'm a web development enthusiast <br /> based in Wrocław, Poland.{" "}
      ...
      {langctx.language && (
        <div className={styles.hero}>
          <p className={styles.hero__welcome}>
            ...
            jestem Front end developerem <br /> z Wrocławia. <br /> Jak masz czas i
